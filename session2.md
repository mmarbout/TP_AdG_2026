...
```sh
hicstuff pipeline --genome ref/PAO.fa --binning 1000 --distance-law --duplicates --enzyme DpnII,HinfI --filter --outdir HiC/binome_1_1/ --plot --prefix binome_1_1 --threads 4 --skip-count fastq/Binome_1_1_R1.fq.gz fastq/Binome_1_1_R2.fq.gz
```
